    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">The requested blog post could not be loaded.</p>
        </div>
      </div>
    )
  }
        ...
        <ReactMarkdown
          ...
          components={{
            ...
            h2: ({node, children, ...props}) => (
              <h2 className="text-2xl font-semibold mt-8 mb-3 text-foreground" {...props}>
                {children}
              </h2>
            ),
            ...
            pre: ({node, children, ...props}) => (
              <pre className="bg-card border border-border rounded-lg p-4 overflow-x-auto my-6 shadow-lg" {...props}>
                {children}
              </pre>
            ),
          }}
